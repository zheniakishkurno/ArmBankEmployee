...
namespace WindowsFormsApp1
{
    public partial class Form13 : Form
    {
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            if (guna2DataGridView1.SelectedRows.Count > 0)
            {
                ...
                foreach (DataGridViewRow row in guna2DataGridView1.SelectedRows)
                {
                    ...
                    {
                        int idreservation = Convert.ToInt32(row.Cells["idreservation"].Value); // Предположим, что "idcredit" - это имя столбца с уникальным идентификатором строки
        ...
        {
            string filePath = $"SelectedRows_{rows[0].Cells["idreservation"].Value}_{rows[0].Cells["idreservation"].Value}.docx";
